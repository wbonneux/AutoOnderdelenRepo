...
class SearchRequestMySqlDAO extends BaseCommonMySqlDAO {
	...
	public function insert($searchRequest){
		...
		$sqlQuery->setString($searchRequest->chassis);
		$sqlQuery->setString($searchRequest->kilowatt);
	...
	public function readRow($row){
		...
		$searchRequest->chassis = $row['T_I_CHASSIS'];
		$searchRequest->kilowatt = $row['T_I_KILOWATT'];
