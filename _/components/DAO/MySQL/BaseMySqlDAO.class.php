...
class BaseMySqlDAO implements BaseDAO
{
	...
	/**
	 * get the correct description with the given language
	 */
	public function getDescrColumn($lang) {
		if($lang == 'nl')
		{
			return 'T_I_DESCR_NDLS';
		}
		if($lang == 'fr')
		{
			return 'T_I_DESCR_FRANS';
		}
		if($lang == 'de')
		{
			return 'T_I_DESCR_DUITS';
		}
