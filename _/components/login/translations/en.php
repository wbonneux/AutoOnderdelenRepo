...
define("MY_MESSAGE_PASSWORD_WRONG", "MY MESSAGE: Wrong password. Try again.");
...
define("MY_MESSAGE_PASSWORD_WRONG_3_TIMES", "MY MESSAGE: You have entered an incorrect password 3 or more times already. Please wait 30 seconds to try again.");
