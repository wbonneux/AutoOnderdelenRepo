...
private $validations, $sanatations, $mandatories, $equal, $errors, $required, $corrects, $fields;
...
public function getJSON() {
    ...
    {
    	foreach($this->required as $key=>$val) { $required[$key] = $val; }
    }
    ...
    $output = array('errors' => $errors, 'required' => $required, 'correct' => $correct);
...
private function addRequired($field,$value)
{
